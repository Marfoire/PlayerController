...
public class PlayerMovement : MonoBehaviour
{
...

    {
        ...
        //first jump //take this
        if ((jumpInputted == true && grounded == true) /*regular jump condition*/ || (Time.time - early <= 0.15F && grounded == true /*early jump condition*/ || latePass == true /*late jump condition*/)) 
        {
            
            if (jumpInputted == true)
            {
                isJumping = true;
            }
